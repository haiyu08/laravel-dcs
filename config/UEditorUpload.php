...
*/
    ...
    'upload' => [
        ...
        "imageUrlPrefix" => "http://localhost/public", /* 图片访问路径前缀 */
        // "imagePathFormat" => "/uploads/ueditor/php/upload/image/{yyyy}{mm}{dd}/{time}{rand:6}", /* 
        "imagePathFormat" => "/uploads/{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        "scrawlPathFormat" => "/uploads/{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        "snapscreenPathFormat" => "/uploads/{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        "catcherPathFormat" => "/uploads/{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        "videoPathFormat" => "/uploads/{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        "filePathFormat" => "/uploads/{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
