...
<head>
    ...
    <script type="text/javascript" charset="utf-8" src="/laravel-u-editor/jquery-3.3.1.min.js"> </script>
...
<div>
    ...
    <button onclick="submit_ueditor()">发表文章</button>
</div>
<div id="btns">
    <div>
...
<script type="text/javascript">
    ...
    function submit_ueditor(){ 
        var content = UE.getEditor('editor').getContent();
        var title = $('.title').val(); 
        alert(content);
        alert(title);
        $.ajax({
            url:'http://localhost/edit_ueditor',
            type:'post',
            dataType:'json',
            async:true,   //默认异步
