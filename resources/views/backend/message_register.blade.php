...
require_once './aliyun-dysms/api_sdk/vendor/autoload.php';
...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIpmBUoMHBIa4M"; // AccessKeyId

        $accessKeySecret = "ICs9omb8iVDV3p2N0u1lTSNM6MgzFB"; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($mobile,$type,$code) {
        ...
        $request->setSignName("大长生物流网站");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        if($type == 1){
            $request->setTemplateCode("SMS_126580437");
        }else if($type == 2){ 
            $request->setTemplateCode("SMS_126595473");
        }

        //注册：SMS_126580437     重置密码：SMS_126595473
...
$response = SmsDemo::sendSms($mobile,$type,$code);
echo $code;
